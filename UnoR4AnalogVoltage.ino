#define MaxSonarPin A0                      //Which pin on the Arduino is the Analog voltage line from the MaxBotix sensor connected to? 
                                            //This needs to be an analog input.
...
void loop() {
  analogData = analogRead(MaxSonarPin);     //Return an analog measurement. This is 10 Bit by default on Arduino boards

  rangeDataCM = analogData;                 //The MB1200 has an output resolution of 10 Bits. This means there is 1024 available values.
