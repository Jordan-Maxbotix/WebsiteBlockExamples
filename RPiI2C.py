...
##  Modifications by: Jordan Hofstrand 01-26-2024, Revision 1.1        ##
##                                                                     ##
##  Revision History: 1.0 -- 11-08-2016 -- Created initial code build  ##
##                    1.1 -- 01-26-2024 -- Updated print statements to ##
##                         run properly in Python3 environments.       ##
...
# Please review the full tutorial at https://maxbotix.com/pages/raspberry-pi-landing-page for a step by step guide.
#########################################################################
...
def change_address(old_address, new_address):
  if (new_address != 0) and (new_address != 40) and (new_address != 82) and (new_address != 85):
    ...
    try:
      ...
      print("Please verify the circuit. Also verify the current sensor address.")
  else:
